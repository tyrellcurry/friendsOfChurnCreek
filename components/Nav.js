    ...
    return (
        <div className="px-10vw flex py-4 bg-slate-300">
            <nav className="lg:flex gap-5 justify-between w-full">
                <Link href="/">
                    <Image
                        className="self-start w-full h-auto lg:min-w-[125px] max-w-[100px] lg:max-w-[125px]"
                ...
                <div className="flex flex-col items-center justify-center gap-2 xl:gap-0 xl:flex-row">
                    <ul className="mobile-menu flex hidden flex-col items-center gap-4 pt-4 lg:p-0 lg:flex lg:flex-row lg:gap-8">
                        ...
                        <li>
                            <Link
                                className="link font-semibold hover:text-teal-800 text-lg whitespace-nowrap"
                                href="/events">
                                Events & Activities
                            </Link>
                        </li>
